...
public class TemperatureSettingService {
    ...
    public List<? extends TemperatureSetting> getAllTemperatureSetting(String mode){
        switch (mode.toLowerCase()){
            case "automated":
                TemperatureAutomatedRepository temperatureAutomatedRepository = temperatureSettingFactory.getTempSettingRepository(TemperatureAutomatedRepository.class);
                return temperatureAutomatedRepository.findAll();
            case "manual":
                TemperatureManualRepository temperatureManualRepository = temperatureSettingFactory.getTempSettingRepository(TemperatureManualRepository.class);
                return temperatureManualRepository.findAll();
            case "scheduled":
                TemperatureScheduledRepository temperatureScheduledRepository = temperatureSettingFactory.getTempSettingRepository(TemperatureScheduledRepository.class);
        ...
        switch (mode.toLowerCase()){
            case "automated":
                ...
                TemperatureAutomated temperatureAutomated = temperatureAutomatedRepository.findById(id)
                        .orElseThrow(()->new ResourceNotFoundException("Temperature Setting with id "+id+"doesn't exist!"));
    ...
    public TemperatureSettingResponse<? extends TemperatureSetting> getTemperatureSettingByFarm(String mode, int farm_id){
        Farm farm = farmRepository.findById(farm_id)
                .orElseThrow(()->new ResourceNotFoundException("Farm with id "+farm_id+"doesn't exist!"));
        switch (mode.toLowerCase()){
            case "automated":
                TemperatureAutomatedRepository temperatureAutomatedRepository = temperatureSettingFactory.getTempSettingRepository(TemperatureAutomatedRepository.class);
                TemperatureAutomated temperatureAutomated = temperatureAutomatedRepository.findByFarm_Id(farm_id);
                return TemperatureSettingResponse.builder()
                        .temperatureSetting(temperatureAutomated)
                        .mode(mode)
                        .message("Get temperature setting successfully")
            ...
            case "manual":
                TemperatureManualRepository temperatureManualRepository = temperatureSettingFactory.getTempSettingRepository(TemperatureManualRepository.class);
                TemperatureManual temperatureManual = temperatureManualRepository.findByFarm_Id(farm_id);
                return TemperatureSettingResponse.builder()
                        .temperatureSetting(temperatureManual)
                        .mode(mode)
                        .message("Get temperature setting successfully")
            ...
            case "scheduled":
                TemperatureScheduledRepository temperatureScheduledRepository = temperatureSettingFactory.getTempSettingRepository(TemperatureScheduledRepository.class);
                TemperatureScheduled temperatureScheduled = temperatureScheduledRepository.findByFarm_Id(farm_id);
                return TemperatureSettingResponse.builder()
                        .temperatureSetting(temperatureScheduled)
                        .mode(mode)
                        .message("Get temperature setting successfully")
    ...
    public TemperatureSettingResponse<? extends TemperatureSetting> addTemperatureSetting(String mode, TemperatureSettingRequest request){
    ...
    public TemperatureSettingResponse<? extends TemperatureSetting> updateTemperatureSetting(String mode, int id, TemperatureSettingRequest request){
